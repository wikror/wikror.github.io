# source: https://github.com/reitzig/reitzig.github.io/blob/sources/_plugins/fixbibliography.rb
module Jekyll
  class FixBibBlock < Liquid::Block
    ...
    def render(context)
      ...
      # Make DOI into link
      res.gsub!(/DOI: (\S+)\s+/, "DOI: <a href=\"https://dx.doi.org/\\1\" target=\"_blank\">\\1<\/a>")
